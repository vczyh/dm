...
func (Dm_build_254 *dm_build_0) Dm_build_253(dm_build_255 []byte, dm_build_256 string, dm_build_257 *DmConnection) string {
	...
	for {
		...
		if dm_build_278.dm_build_268 != dm_build_278.dm_build_269 || dm_build_278.dm_build_263 != nil {
			...
			case dm_build_281 == nil:
				...
				continue
			case dm_build_281 == transform.ErrShortDst && (dm_build_278.dm_build_266 != 0 || dm_build_280 != 0):

				continue
			case dm_build_281 == transform.ErrShortSrc && dm_build_278.dm_build_269-dm_build_278.dm_build_268 != len(dm_build_278.dm_build_267) && dm_build_278.dm_build_263 == nil:
